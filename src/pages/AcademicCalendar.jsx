      ...
      <div className="bg-white border rounded-2xl p-6">
        ...
        <div className="overflow-x-auto -mx-6 px-6">
          <div className="flex gap-0 relative min-w-max">
            {/* Connecting line */}
            <div className="absolute top-[38px] left-[36px] right-[36px] h-0.5 bg-border" />
            ...
            {(() => {
              ...
              const displayStart = viewRange.startDate && viewRange.startDate.trim() ? new Date(viewRange.startDate + "T12:00:00") : semStart;
              const displayEnd   = viewRange.endDate && viewRange.endDate.trim() ? new Date(viewRange.endDate + "T12:00:00") : semEnd;
              ...
              const renderCheckinCol = (m, key) => (
                <div key={key} className="flex flex-col items-center text-center w-32 flex-shrink-0 px-2 relative pt-[22px]">
                  <div className="h-5 w-5 rounded-full z-10 border-2 border-amber-400 flex items-center justify-center absolute top-[28px] bg-amber-50">
